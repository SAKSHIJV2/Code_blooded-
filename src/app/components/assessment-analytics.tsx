...
export function AssessmentAnalytics() {
    return (
        <div className="space-y-8 max-w-[1600px] mx-auto w-full animate-in fade-in slide-in-from-bottom-4 duration-500 p-8">
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
                <div>
                    ...
                    <p className="text-slate-500 mt-1 font-medium">
                        Sprint: <span className="text-blue-600 font-bold font-mono">#DELTA-04</span> | End Date: Feb 25
                    </p>
                </div>
                <button className="bg-blue-600 hover:bg-blue-700 text-white px-5 py-2.5 rounded-xl font-bold flex items-center gap-2 transition-all shadow-lg shadow-blue-500/20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
                ...
                <div className="md:col-span-8 bg-white border border-slate-200 rounded-3xl p-8 lg:p-10 shadow-sm relative overflow-hidden">
                    <h2 className="text-xl font-bold text-slate-900 mb-6 flex items-center gap-2">
                        <Activity className="text-blue-500" /> Weekly Performance
                    </h2>
                ...
                <div className="md:col-span-4 bg-white border border-slate-200 rounded-3xl p-8 shadow-sm hover:border-blue-500/30 transition-colors group">
                    ...
                    <div className="text-5xl font-black text-slate-900 group-hover:text-blue-600 transition-colors">142</div>
                    <p className="text-sm text-slate-400 mt-2 font-medium">Across 8 simulated sprints</p>
                </div>

                {/* 4. ACTIVITY & CONSISTENCY (8 cols) */}
                <div className="md:col-span-8 bg-white border border-slate-200 rounded-3xl p-8 shadow-sm hover:border-blue-500/30 transition-colors flex flex-col">
                ...
                <div className="md:col-span-12 bg-white border border-slate-200 rounded-3xl p-8 shadow-sm hover:border-blue-500/30 transition-colors">
        ...
        <div className="flex items-center justify-between p-4 bg-slate-50 rounded-2xl border border-slate-100 hover:border-slate-200 hover:shadow-sm transition-all group">
            <div className="flex items-center gap-3 flex-1">
                <div className="w-8 h-8 rounded-lg bg-white border border-slate-200 flex items-center justify-center shadow-sm">
                    <Zap size={14} className="text-slate-400 group-hover:text-blue-500 transition-colors" />
                </div>
